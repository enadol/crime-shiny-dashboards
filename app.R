...
header <- dashboardHeader(title = "EVOLUCIÓN DEL DELITO EN MÉXICO 1997-2017", titleWidth = 600)

body <- dashboardBody(tags$head(tags$link(rel="icon", href="favicon.ico"),
                                #twitter
                                ...
                                tags$head(tags$meta(name="twitter:description", content="Evolución del crimen en México 1997-2017.")),
                                tags$head(tags$meta(name="twitter:creator", content="@EnriqueALopezM")),
                                tags$head(tags$meta(name="twitter:image", content="http://www.enadol.de/images/crimev2.JPG")),
                                
                                #facebook
                                tags$head(tags$meta(property="og:title", content="Análisis interactivo. Evolución del crimen en México 1997-2017.")),
                                tags$head(tags$meta(property="og:type", content="article")),
                                tags$head(tags$meta(property="og:url", content="http://data.enadol.de/shiny/crimev2")),
                                tags$head(tags$meta(property="og:image", content="http://www.enadol.de/images/crimev2.JPG")),
                                tags$head(tags$meta(property="og:description", content="Gráficas por número de casos y tasa por cada 100.000 habitantes"))
